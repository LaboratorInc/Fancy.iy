**Fancy Issue Reporting:** *REPORT ANY ISSUES IN THE ISSUE SECTION WITH THE 'bug' LABEL ONLY. IF THE BUG IS FOUND IN THE BETA VERSION, ADD 'bug' AND 'beta' LABEL, 'beta' LABEL IS ONLY USED FOR IF THE BUG IS FOUND IN THE BETA VERSION*
